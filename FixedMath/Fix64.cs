...
namespace FixMath.NET
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 FixPrecision = new Fix64(1L);
        ...
        public static readonly Fix64 Three = Fix64.From(3);
        public static readonly Fix64 Zero = new Fix64();
        public static readonly Fix64 Half = Fix64.From(0, 5);
        public static readonly Fix64 OneAndHalf = Fix64.From(1, 5);
        /// <summary>
        /// The value of Pi
        /// </summary>
        ...
        public static Fix64 Asin(Fix64 x)
        {
            ...
            if (x.m_rawValue == 0) return Fix64.Zero;

            var result = Atan(x / Sqrt(One - x * x));
            // Unsure what this line does below.
            // Might cause bug later down the line.
