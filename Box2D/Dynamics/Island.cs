...
namespace Box2DX.Dynamics
{
 ...
 b._angularVelocity * b._angularVelocity > angTolSqr ||
        ...
        private static readonly Fix64 TOI_BAUMGARTE = Fix64.From("0.75");
        ...
        public void SolveTOI(ref TimeStep subStep)
        {
            ...
            {
                bool contactsOkay = contactSolver.SolvePositionConstraints(TOI_BAUMGARTE);
                bool jointsOkay = true;
                for (int j = 0; j < _jointCount; ++j)
                {
                    bool jointOkay = _joints[j].SolvePositionConstraints(TOI_BAUMGARTE);
                    jointsOkay = jointsOkay && jointOkay;
                }
