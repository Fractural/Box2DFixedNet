...
namespace Box2DX.Dynamics
{
    ...
    public class Fixture
    {
        ...
        public Fix64 ComputeSubmergedArea(Vec2 normal, Fix64 offset, out Vec2 c)
        {
        ...
        public SegmentCollide TestSegment(out Fix64 lambda, out Vec2 normal, Segment segment, Fix64 maxLambda)
        {
        ...
        /// </summary>
        public Fix64 ComputeSweepRadius(Vec2 pivot)
        {
