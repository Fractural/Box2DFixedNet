...
namespace Box2DX.Dynamics
{
    ...
    public struct Jacobian
    {
        ...
        public void Set(Vec2 x1, Fix64 a1, Vec2 x2, Fix64 a2)
        {
            Linear1 = x1; Angular1 = a1;
            Linear2 = x2; Angular2 = a2;
        }

        public Fix64 Compute(Vec2 x1, Fix64 a1, Vec2 x2, Fix64 a2)
        {
...
#warning "CAS"
    ...
    public abstract class Joint
    {
        ...
        /// </summary>		
        public abstract Vec2 GetReactionForce(Fix64 inv_dt);
        ...
        internal void ComputeXForm(ref XForm xf, Vec2 center, Vec2 localCenter, Fix64 angle)
        {
            xf.R.Set(angle);
