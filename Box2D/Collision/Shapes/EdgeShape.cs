...
namespace Box2DX.Collision
{
    public class EdgeShape : Shape
    {
        ...
        public void Set(Vec2 v1, Vec2 v2)
        {
            ...
            _normal = Vec2.Cross(_direction, Fix64.One);
        ...
        public override Fix64 ComputeSubmergedArea(Vec2 normal, Fix64 offset, XForm xf, out Vec2 c)
        {
            ...
            Fix64 d1 = Vec2.Dot(normal, v1) - offset;
            Fix64 d2 = Vec2.Dot(normal, v2) - offset;
            ...
            Fix64 k_inv3 = Fix64.One / Fix64.Three;
            ...
            return Fix64.Half * Vec2.Cross(e1, e2);
        }
        ...
        {
            Fix64 ds1 = Vec2.DistanceSquared(_v1, pivot);
            Fix64 ds2 = Vec2.DistanceSquared(_v2, pivot);
