...
namespace Box2DX.Collision
{
    ...
    public partial class Collision
    {
        ...
        public static int ClipSegmentToLine(out ClipVertex[/*2*/] vOut, ClipVertex[/*2*/] vIn, Vec2 normal, Fix64 offset)
        {
            ...
            Fix64 distance0 = Vec2.Dot(normal, vIn[0].V) - offset;
            Fix64 distance1 = Vec2.Dot(normal, vIn[1].V) - offset;
    ...
    public struct Segment
    {
        ...
        /// </summary>
        public bool TestSegment(out Fix64 lambda, out Vec2 normal, Segment segment, Fix64 maxLambda)
        {
            lambda = Fix64.Zero;
            normal = new Vec2();
            ...
            Vec2 r = segment.P2 - s;
            Vec2 d = P2 - P1;
            Vec2 n = Vec2.Cross(d, Fix64.One);

            Fix64 k_slop = Fix64.From(100) * Common.Settings.FLT_EPSILON;
            Fix64 denom = -Vec2.Dot(r, n);
    ...
    public struct AABB
    {
        ...
        public Vec2 Center
        {
            get { return Fix64.Half * (LowerBound + UpperBound); }
        }

        /// Get the extents of the AABB (half-widths).
        public Vec2 Extents
        {
            get { return Fix64.Half * (UpperBound - LowerBound); }
        }
        ...
        public void RayCast(out RayCastOutput output, RayCastInput input)
        {
            ...
            Vec2 normal = new Vec2(Fix64.Zero);
                ...
                case ManifoldType.Circles:
                    {
                        ...
                        Vec2 normal = new Vec2(Fix64.One, Fix64.Zero);
